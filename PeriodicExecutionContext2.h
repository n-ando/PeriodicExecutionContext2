// -*- C++ -*-
/*!
 * @file PeriodicExecutionContext2.h
...
namespace RTC
{
  /*!
   * @if jp
   * @class PeriodicExecutionContext2
   * @brief PeriodicExecutionContext2 クラス
   *
   * Periodic Sampled Data Processing(周期実行用)ExecutionContext2クラス。
   *
   * @since 0.4.0
   *
   * @else
  ...
  public:
     ...
     * @endif
     */
    virtual ~PeriodicExecutionContext2(void);
...
#endif // RTC_PERIODICEXECUTIONCONTEXT2_H
