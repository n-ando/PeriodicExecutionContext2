...
#include "PeriodicExecutionContext2.h"
...
namespace RTC
{
  ...
  {
    RTC_TRACE(("PeriodicExecutionContext2()"));
   ...
   */
  PeriodicExecutionContext2::
  PeriodicExecutionContext2(OpenRTM::DataFlowComponent_ptr owner,
			   double rate)
    : rtclog("periodic_ec"), m_running(false), m_svc(true), m_nowait(true)
  {
    RTC_TRACE(("PeriodicExecutionContext2(owner, rate = %f)", rate));
   ...
   * @endif
   */
  PeriodicExecutionContext2::~PeriodicExecutionContext2()
  {
    RTC_TRACE(("~PeriodicExecutionContext2()"));
   ...
   * @endif
   */
  int PeriodicExecutionContext2::open(void *args)
  {
    RTC_TRACE(("open()"));
    activate();
    return 0;
   ...
   * @endif
   */
  int PeriodicExecutionContext2::svc(void)
  {
    RTC_TRACE(("svc()"));
    int count(0);
    do 
   ...
   * @endif
   */
  int PeriodicExecutionContext2::close(unsigned long flags)
  {
    RTC_TRACE(("close()"));
   ...
   * @endif
   */
  CORBA::Boolean PeriodicExecutionContext2::is_running()
   ...
   * @endif
   */
  ReturnCode_t PeriodicExecutionContext2::start()
    throw (CORBA::SystemException)
  {
    RTC_TRACE(("start()"));
   ...
   * @endif
   */
  ReturnCode_t PeriodicExecutionContext2::stop()
    throw (CORBA::SystemException)
  {
    RTC_TRACE(("stop()"));
    if (!m_running) return RTC::PRECONDITION_NOT_MET;
   ...
   * @endif
   */
  CORBA::Double PeriodicExecutionContext2::get_rate()
    throw (CORBA::SystemException)
  {
    RTC_TRACE(("get_rate()"));
   ...
   * @endif
   */
  ReturnCode_t PeriodicExecutionContext2::set_rate(CORBA::Double rate)
    throw (CORBA::SystemException)
  {
   ...
   */ 
  ReturnCode_t
  PeriodicExecutionContext2::activate_component(LightweightRTObject_ptr comp)
    throw (CORBA::SystemException)
  {
...
// Why RtORB does not allow STL's find_if and iterator?
   ...
   */  
  ReturnCode_t
  PeriodicExecutionContext2::deactivate_component(LightweightRTObject_ptr comp)
    throw (CORBA::SystemException)
  {
...
// Why RtORB does not allow STL's find_if and iterator?
   ...
   */  
  ReturnCode_t
  PeriodicExecutionContext2::reset_component(LightweightRTObject_ptr comp)
    throw (CORBA::SystemException)
  {
   ...
   */
  LifeCycleState
  PeriodicExecutionContext2::get_component_state(LightweightRTObject_ptr comp)
    throw (CORBA::SystemException)
  {
   ...
   * @endif
   */
  ExecutionKind PeriodicExecutionContext2::get_kind()
    throw (CORBA::SystemException)
  {
    RTC_TRACE(("get_kind()"));
   ...
   */
  ReturnCode_t
  PeriodicExecutionContext2::add_component(LightweightRTObject_ptr comp)
    throw (CORBA::SystemException)
  {
  ...
  RTC::ReturnCode_t PeriodicExecutionContext2::bindComponent(RTObject_impl* rtc)
  {
   ...
   */	
  ReturnCode_t
  PeriodicExecutionContext2::remove_component(LightweightRTObject_ptr comp)
    throw (CORBA::SystemException)
  {
   ...
   * @endif
   */
  ExecutionContextProfile* PeriodicExecutionContext2::get_profile()
    throw (CORBA::SystemException)
  {
...
extern "C"
{
   ...
   * @endif
   */
  void PeriodicExecutionContext2Init(RTC::Manager* manager)
  {
    manager->registerECFactory("PeriodicExecutionContext2",
			       RTC::ECCreate<RTC::PeriodicExecutionContext2>,
			       RTC::ECDelete<RTC::PeriodicExecutionContext2>);
  }
};
